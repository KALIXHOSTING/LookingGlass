...
<div class="col-lg-6 mx-auto p-3 py-md-5">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <a href="<?php echo $templateData['facility_url'] ?>" class="btn btn-outline-secondary" target="_blank">DATACENTER</a>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="pt-3 mt-5 my-5 text-muted border-top">
        Powered by <a href="https://lookingglass.kalixhosting.com" target="_blank">KalixHosting - Media Streaming Solutions</a>
        <a href="https://lookingglass.kalixhosting.com"" target="_blank" class="float-end"><img src="" alt="KalixHosting"></a>
    </footer>
</div>
